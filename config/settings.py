...
class Constants(BaseSettings):
    BELIEVABILITY_SCORE_PREDICTOR: ClassVar[XGBRegressor] =  pickle.load(open("config/models/B.pkl", "rb"))
    MOTIVATION_SCORE_PREDICTOR: ClassVar[XGBRegressor] =  pickle.load(open("config/models/M.pkl", "rb"))
    DIFFERENTIATION_SCORE_PREDICTOR: ClassVar[XGBRegressor] = pickle.load(open("config/models/D.pkl", "rb"))
    TFIDF_VECTORIZER_LESS_FEATURES: ClassVar[TfidfVectorizer] = TfidfVectorizer(max_features=10, stop_words="english")
    TFIDF_VECTORIZER_MORE_FEATURES: ClassVar[TfidfVectorizer] = TfidfVectorizer(max_features=200, stop_words="english")
...
Calculate the readability score of the message using either the Flesch-Kincaid Grade Level formula. Output the result as a grade level (e.g., 8.5, indicating an 8th-grade reading level).  Ensure the calculation accounts for the number of words, sentences, and syllables (for Flesch-Kincaid) or characters (for ARI) in the message text. Exclude any non-text elements (e.g., images, charts) from the calculation.
 ...
 Input Message: $message
    ...
    *** Details on output ***
    ...
    IMPROVISED MESSAGES:
    - [List 1-3 improved versions of the message that address the weaknesses and enhance strengths]

    *** End of Details ***
    """)
    DISCREPANCY_THRESHOLD:int=50
    REQUIRED_FEATURES:dict = {
        "Motivation": ['unique_selling_proposition', 'metric_count', 'tfidf_48', 'tfidf_110', 'brand_name_tfidf_5', 'tfidf_118', 'tfidf_199', 'tfidf_44', 'tfidf_70', 'word_count', 'tone', 'brand_name_tfidf_9', 'tfidf_124', 'tfidf_69', 'tfidf_106', 'tfidf_175', 'brand_name_tfidf_4', 'tfidf_27', 'specific_condition_tfidf_4', 'tfidf_197', 'tfidf_126', 'tfidf_58', 'tfidf_190', 'specific_condition_tfidf_9', 'tfidf_82', 'tfidf_147', 'tfidf_180', 'tfidf_127', 'tfidf_158', 'action_words_tfidf_1', 'specific_condition_tfidf_3', 'tfidf_8', 'average_char_count', 'tfidf_87', 'tfidf_74', 'technical_terms_tfidf_5', 'tfidf_85', 'tfidf_22', 'tfidf_81', 'tfidf_51', 'tfidf_181', 'tfidf_80', 'tfidf_60', 'tfidf_189', 'tfidf_92', 'action_words_tfidf_0', 'brand_name_tfidf_8', 'tfidf_32', 'tfidf_91', 'tfidf_140', 'tfidf_38', 'tfidf_164', 'tfidf_195', 'datapoint_count', 'tfidf_3', 'tfidf_75', 'tfidf_26', 'action_words_count', 'tfidf_34', 'technical_terms_tfidf_4', 'tfidf_86', 'tfidf_133', 'tfidf_112', 'tfidf_154', 'action_words_tfidf_9', 'tfidf_182', 'tfidf_161', 'tfidf_15', 'readability_score', 'action_words_tfidf_4', 'tfidf_155', 'tfidf_31', 'tfidf_57', 'tfidf_9', 'tfidf_169', 'tfidf_63', 'word_complexities_tfidf_8', 'tfidf_24', 'tfidf_165', 'tfidf_12', 'specific_condition_tfidf_1', 'tfidf_160', 'tfidf_168', 'tfidf_77', 'tfidf_121', 'tfidf_89', 'tfidf_185', 'tfidf_109', 'tfidf_67', 'action_words_tfidf_6', 'word_complexities_tfidf_1', 'tfidf_194', 'call_to_action', 'tfidf_113', 'specific_condition_tfidf_8', 'tfidf_79', 'technical_terms_tfidf_9', 'tfidf_71', 'specific_condition_tfidf_5', 'tfidf_187', 'tfidf_101', 'brand_name_tfidf_0', 'technical_terms_tfidf_6', 'tfidf_159', 'tfidf_115', 'brand_name_tfidf_1', 'tfidf_33', 'tfidf_198', 'technical_terms_tfidf_1', 'brand_name_tfidf_7', 'tfidf_163', 'action_words_tfidf_8', 'tfidf_66', 'tfidf_98', 'tfidf_41', 'tfidf_28', 'tfidf_144', 'word_complexities_tfidf_9', 'tfidf_50', 'tfidf_39', 'tfidf_88', 'tfidf_153', 'tfidf_149', 'tfidf_68', 'tfidf_130', 'tfidf_11', 'tfidf_172', 'tfidf_142', 'tfidf_136', 'tfidf_148', 'tfidf_84', 'passive_voice', 'word_complexities_tfidf_5', 'tfidf_100', 'tfidf_1', 'tfidf_83', 'tfidf_21', 'tfidf_167', 'word_complexities_tfidf_3', 'tfidf_102', 'tfidf_117', 'tfidf_139', 'tfidf_166', 'tfidf_72', 'technical_terms_tfidf_0', 'action_words_tfidf_7', 'tfidf_191', 'tfidf_94', 'tfidf_129', 'specific_condition_tfidf_0', 'tfidf_107', 'char_count', 'tfidf_18', 'tfidf_7', 'tfidf_116', 'word_complexities_tfidf_2', 'brand_name_tfidf_2', 'tfidf_61', 'tfidf_59', 'tfidf_62', 'tfidf_114', 'tfidf_65', 'tfidf_64', 'tfidf_73', 'tfidf_78', 'tfidf_76', 'tfidf_90', 'tfidf_93', 'tfidf_5', 'tfidf_6', 'tfidf_4', 'tfidf_2', 'tfidf_10', 'tfidf_13', 'tfidf_55', 'tfidf_56', 'tfidf_52', 'tfidf_53', 'tfidf_54', 'tfidf_103', 'tfidf_105', 'tfidf_104', 'tfidf_108', 'tfidf_111', 'tfidf_97', 'tfidf_96', 'tfidf_95', 'tfidf_99', 'tfidf_17', 'tfidf_16', 'tfidf_14', 'word_complexities_tfidf_4', 'comparator', 'word_complexities_tfidf_6', 'word_complexities_tfidf_7', 'tfidf_151', 'tfidf_135', 'tfidf_125', 'tfidf_120', 'tfidf_119'],
